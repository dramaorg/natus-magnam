# @dramaorg/natus-magnam

[![NPM](https://img.shields.io/npm/v/@dramaorg/natus-magnam.svg?style=flat-square)](https://www.npmjs.com/package/@dramaorg/natus-magnam)
[![GitHub Workflow Status (master)](https://img.shields.io/github/actions/workflow/status/jhildenbiddle/@dramaorg/natus-magnam/test.yml?branch=master&label=checks&style=flat-square)](https://github.com/dramaorg/natus-magnam/actions?query=branch%3Amaster+)
[![Codacy code quality](https://img.shields.io/codacy/grade/ec8f2d2595804ab38ad138b762a640e6/master?style=flat-square)](https://app.codacy.com/gh/jhildenbiddle/@dramaorg/natus-magnam/dashboard?branch=master)
[![Codacy branch coverage](https://img.shields.io/codacy/coverage/ec8f2d2595804ab38ad138b762a640e6/master?style=flat-square)](https://app.codacy.com/gh/jhildenbiddle/@dramaorg/natus-magnam/dashboard?branch=master)
[![License: MIT](https://img.shields.io/badge/License-MIT-yellow.svg?style=flat-square)](https://github.com/dramaorg/natus-magnam/blob/master/LICENSE)
...
```shell
npm install @dramaorg/natus-magnam --save
```

```javascript
// file.js
import getCssData from '@dramaorg/natus-magnam';
...
```bash
git clone https://github.com/dramaorg/natus-magnam.git
```
...
```html
<!-- ES5 (latest v2.x.x) -->
<script src="https://cdn.jsdelivr.net/npm/@dramaorg/natus-magnam@2"></script>
<script>
  getCssData({
    onComplete: function(cssText, cssArray, nodeArray) {
      // Do stuff...
...
<script type="module">
  import getCssData from 'https://cdn.jsdelivr.net/npm/@dramaorg/natus-magnam@2/dist/@dramaorg/natus-magnam.esm.min.js';
...
- Create a 💬 [GitHub issue](https://github.com/dramaorg/natus-magnam/issues) for bug reports, feature requests, or questions
- Add a ⭐️ [star on GitHub](https://github.com/dramaorg/natus-magnam) and 🐦 [tweet](https://twitter.com/intent/tweet?url=https%3A%2F%2Fgithub.com%2Fjhildenbiddle%2F@dramaorg/natus-magnam&hashtags=css,developers,frontend,javascript) to promote the project
- Become a 💖 [sponsor](https://github.com/sponsors/jhildenbiddle) to support the project and future efforts

## License

This project is licensed under the MIT License. See the [LICENSE](https://github.com/dramaorg/natus-magnam/blob/master/LICENSE) for details.
